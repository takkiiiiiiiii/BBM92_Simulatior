...
sigma_theta_x = theta_rad/10 # Standard deviation of pointing error in x (radians)
sigma_theta_y = theta_rad/10 # Standard deviation of pointing error in y (radians)
